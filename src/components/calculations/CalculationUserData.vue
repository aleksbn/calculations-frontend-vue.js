      ...
      <div class="dialog">
        <base-card>
          <p style="text-align: justify">
            You may choose the action. If you don't want to enter your data,
            just press "Add as anonymous" and the calculation will be addes as
            anonymous one.
          </p>
          <p style="text-align: justify">
          ...
          <p style="text-align: justify">
            ...
            displayed at the start of the calculations list and it will be
